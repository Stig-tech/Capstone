...
type Element = typeof globalThis extends { Element: { new (): infer T } }
  ? T
  : never;
type Document = typeof globalThis extends { Document: { new (): infer T } }
  ? T
  : never;
type DocumentFragment = typeof globalThis extends {
  DocumentFragment: { new (): infer T };
}
  ? T
  : never;
