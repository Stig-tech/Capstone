...
```
    ...
    always(
      ...
      ...alwaysCallbacks: Array<
        TypeOrArray<Deferred.CallbackBase<TR | TJ, UR | UJ, VR | VJ, SR | SJ>>
      >
    ): this;
    /**
...
```
  ...
  type EventType = keyof RemoveIndexSignature<
    TypeToTriggeredEventMap<any, any, any, any>
  >;
  ...
  > = EventHandlerBase<
    TCurrentTarget,
    NamespacedTypeToTriggeredEventMap<
      TDelegateTarget,
      TData,
      TCurrentTarget,
      TTarget
  ...
  type _TypeEventHandlers<TDelegateTarget, TData, TCurrentTarget, TTarget> = {
    [TType in keyof NamespacedTypeToTriggeredEventMap<
      TDelegateTarget,
      TData,
      TCurrentTarget,
      TTarget
